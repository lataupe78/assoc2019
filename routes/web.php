...
Route::get('/section/{section}/subscriptions', 'Front\SubscriptionController@index')->name('subscriptions.index');

Route::get('/section/{section}/subscriptions/{subscription}', 'Front\SubscriptionController@show')->name('subscriptions.show');
